	            ...
	            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
	             <!--    <li class="nav-item"><a class="nav-link active" aria-current="page" href="/">Home</a></li> -->
	                ...
	                <li class="nav-item dropdown">
	                    ...
	                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	                        <li><a class="dropdown-item" href="<%=path_hd %>/product/productList.do">상품목록</a></li>
	                        <li><a class="dropdown-item" href="#!">상품카테고리 등록</a></li>
	                        <li><a class="dropdown-item" href="<%=path_hd %>/databankForm.do">상품등록</a></li>
	                        <li><a class="dropdown-item" href="#!">상품 정보 수정</a></li>
	                        <li><hr class="dropdown-divider"></li>
	                        <li><a class="dropdown-item" href="<%=path_hd %>/admin/deleteProductForm.do">상품삭제</a></li>
	                    </ul>
	                </li>
	                <li class="nav-item dropdown">
	                    <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">고객관리</a>
	                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	                        <li><a class="dropdown-item" href="<%=path_hd %>/admin/list.do">고객목록</a></li>
                   	        <li><a class="dropdown-item" href="<%=path_hd %>/payment/list.do">고객별 구입 목록</a></li>
	                ...
	                <li class="nav-item dropdown">
	                    ...
	                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	                        <li><a class="dropdown-item" href="<%=path_hd %>/board/list.do">공지 사항 관리</a></li>
                   	        <li><a class="dropdown-item" href="<%=path_hd %>/qna/replyRead.do">댓글 관리</a></li>
	                        <li><a class="dropdown-item" href="<%=path_hd %>/qna/list.do">질문 및 답변 관리</a></li>	
	                     </ul>
	                </li>
	                <li class="nav-item dropdown">
