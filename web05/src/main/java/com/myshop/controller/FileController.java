...
import com.myshop.service.FileService;
...
//    	log.info("파일 업로드 위치 : "+resource.getFile().getCanonicalPath());
    	//myfile.transferTo(new File("d:/kim3/fileUplad/"+filename)); //절대경로
    	log.info("파일 저장 성공");
        return "redirect:/";
    } 	/*  D:\\kimyen\\jsp3\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\web05\\WEB-INF\\views\\upload\\ 에 저장됨  */
	...
	public String multiFileUpload(MultipartFile[] files) {
		String uploadFolder = "D:\\kimyen\\jsp3\\web05\\src\\main\\webapp\\WEB-INF\\views\\upload";
...
//			System.out.println("업로드 파일 크기 : "+file.getSize());
	...
	public String databankInsert(MultipartFile fileurl, HttpServletRequest request, Model model) throws UnsupportedEncodingException, Exception {
		...
		databank.setAutor(request.getParameter("author"));
